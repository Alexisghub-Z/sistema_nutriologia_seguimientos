    ...
    <div className={styles.container}>
      ...
      {pagination.total > 0 && (
        <div className={styles.paginationInfo}>
          ...
          <strong>{pagination.total}</strong> consultas
        </div>
      )}
      ...
      <div className={styles.timeline}>
        {consultas.map((consulta, index) => {
          ...
          const consultaNumber = pagination.total - (pagination.page - 1) * pagination.limit - index
          return (
              ...
              >
                <div className={styles.headerLeft}>
                  ...
                  <div>
                    ...
                    <p className={styles.consultaDate}>{formatearFecha(consulta.fecha)}</p>
                  </div>
                </div>
                ...
                <CardContent className={styles.consultaContent}>
                      ...
                      <div className={styles.mediciones}>
                        {consulta.peso && (
                          <div className={styles.medicion}>
                            ...
                            <span className={styles.medicionValue}>{consulta.peso} kg</span>
                          </div>
                        )}
                        {consulta.talla && (
                          <div className={styles.medicion}>
                            <span className={styles.medicionLabel}>Talla:</span>
                            <span className={styles.medicionValue}>{consulta.talla} m</span>
                          </div>
                        )}
                        {consulta.imc && (
                          <div className={styles.medicion}>
                      ...
                      <div className={styles.mediciones}>
                        {consulta.grasa_corporal && (
                          <div className={styles.medicion}>
                            ...
                            <span className={styles.medicionValue}>{consulta.grasa_corporal}%</span>
                          </div>
                        )}
                        {consulta.porcentaje_agua && (
                          <div className={styles.medicion}>
                        ...
                        {consulta.grasa_visceral && (
                          <div className={styles.medicion}>
                            ...
                            <span className={styles.medicionValue}>{consulta.grasa_visceral}</span>
                          </div>
                        )}
                      </div>
                    </div>
                      ...
                      <div className={styles.mediciones}>
                        ...
                        {consulta.cintura && (
                          <div className={styles.medicion}>
                            ...
                            <span className={styles.medicionValue}>{consulta.cintura} cm</span>
                          </div>
                        )}
                        {consulta.cadera_maximo && (
                          <div className={styles.medicion}>
                        ...
                        {consulta.muslo_maximo && (
                          <div className={styles.medicion}>
                            ...
                            <span className={styles.medicionValue}>{consulta.muslo_maximo} cm</span>
                          </div>
                        )}
                        {consulta.muslo_medio && (
                          <div className={styles.medicion}>
                            <span className={styles.medicionLabel}>Muslo medio:</span>
                            <span className={styles.medicionValue}>{consulta.muslo_medio} cm</span>
                          </div>
                        )}
                        {consulta.pantorrilla_maximo && (
                          <div className={styles.medicion}>
                        ...
                        {consulta.archivos.map((archivo) => (
                          <div key={archivo.id} className={styles.archivoItem}>
                            ...
                            <div className={styles.archivoInfo}>
                              <div className={styles.archivoNombre}>{archivo.nombre_original}</div>
                              <div className={styles.archivoMeta}>
                                <Badge variant={getCategoriaColor(archivo.categoria) as any}>
                  ...
                  <div className={styles.consultaActions}>
                    <Button
                      ...
                      size="small"
                      onClick={() =>
                        router.push(`/pacientes/${pacienteId}/consultas/${consulta.id}/archivos`)
                      }
                    >
