...
const preguntasFrecuentes: Pregunta[] = [
  ...
  {
    pregunta: '⏱️ ¿Cuánto dura una consulta?',
    respuesta:
      'La primera consulta dura aproximadamente 60 minutos. Las consultas de seguimiento tienen una duración de 30-45 minutos.',
    categoria: 'Consultas',
  },
  {
    pregunta: '💻 ¿Ofrecen consultas en línea?',
    respuesta:
      'Sí, ofrecemos consultas tanto presenciales como en línea por videollamada. Puedes elegir la modalidad que prefieras al agendar tu cita.',
    categoria: 'Consultas',
  },
  {
    pregunta: '📋 ¿Qué necesito para la primera consulta?',
    respuesta:
      'Para tu primera consulta necesitas: ayuno de 8-12 horas si vas a tomarte medidas, estudios de laboratorio recientes (si los tienes), y una lista de medicamentos que tomes actualmente.',
    categoria: 'Consultas',
  },
  {
    pregunta: '📅 ¿Cada cuánto son las consultas de seguimiento?',
    respuesta:
      'Generalmente recomendamos consultas de seguimiento cada 2-4 semanas, dependiendo de tus objetivos y progreso. El seguimiento personalizado es clave para lograr resultados sostenibles.',
    categoria: 'Seguimiento',
  },
  {
    pregunta: '👶 ¿Atienden a niños?',
    respuesta:
      'Sí, ofrecemos consultas de nutrición pediátrica para niños y adolescentes. Trabajamos con planes alimenticios adaptados a cada etapa de crecimiento.',
    categoria: 'Servicios',
  },
  {
...
export default function ChatFAQ() {
  ...
  const [mensajes, setMensajes] = useState<Array<{ tipo: 'bot' | 'usuario'; texto: string }>>([
    {
      tipo: 'bot',
      texto: '¡Hola! 👋 Soy el asistente virtual del consultorio. ¿En qué puedo ayudarte?',
    },
  ])
    ...
    <>
      ...
      {isOpen && (
        <div className={styles.chatWindow}>
          ...
          {/* Preguntas frecuentes arriba - siempre visibles */}
          <div className={styles.preguntasSection}>
            <p className={styles.preguntasTitulo}>Selecciona una pregunta:</p>
